...
replace github.com/projectdiscovery/httpx v1.6.10 => ./libs/httpx
...
replace github.com/cloudflare/circl => github.com/cloudflare/circl v1.3.8
...
require (
	...
	github.com/trufflesecurity/trufflehog/v3 v3.90.0
