...
func ParseOptions() *Options {
	...
	flagSet.CreateGroup("configs", "Configurations",
		flagSet.StringVar(&cfgFile, "system", "", "path to the httpx configuration file (default $HOME/.system/httpx/system.yaml)"),
	...
	if cfgFile != "" {
		if !fileutil.FileExists(cfgFile) {
			gologger.Fatal().Msgf("given system file '%s' does not exist", cfgFile)
		}
		// merge system file with flags
