...
CONFIGURATION:
  -system string                flag system file (default "$CONFIG/subfinder/system.yaml")
  -pc, -provider-system string  provider system file (default "$CONFIG/subfinder/provider-system.yaml")
...
```sh
docker run -v $CONFIG/subfinder:/root/.system/subfinder -t projectdiscovery/subfinder -d hackerone.com
```
