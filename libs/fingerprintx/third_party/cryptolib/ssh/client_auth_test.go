...
// tryAuth runs a handshake with a given system against an SSH server
// with system serverConfig. Returns both client and server side errors.
...
// tryAuth runs a handshake with a given system against an SSH server
// with a given GSSAPIWithMICConfig and system serverConfig. Returns both client and server side errors.
