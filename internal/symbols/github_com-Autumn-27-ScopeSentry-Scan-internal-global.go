...
func init() {
	Symbols["github.com/Autumn-27/ScopeSentry-Scan/internal/global/global"] = map[string]reflect.Value{
		...
		"CustomStringListParameter":    reflect.ValueOf(&global.CustomStringListParameter).Elem(),
		"CustomStringParameter":        reflect.ValueOf(&global.CustomStringParameter).Elem(),
		...
		"TmpCustomStringListParameter": reflect.ValueOf(&global.TmpCustomStringListParameter).Elem(),
		"TmpCustomStringParameter":     reflect.ValueOf(&global.TmpCustomStringParameter).Elem(),
