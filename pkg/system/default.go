...
var (
	SubfinderDefaultConfig = []byte(`binaryedge:
censys:
certspotter: []
passivetotal:
redhuntlabs:
...
intelx:`)
	...
	subdomainDicDefault = []byte(`concours
downloader
lidia
partner1
c.m
...
lhc
uh
prod-chatman-ancillary-eu-central-1
hora
strength
mynewt
pmail
...
crl1
gw.ag
prod-chatman-ancillary-ap-northeast-1
smtp02
app.api
cubic
morpheus
...
alina
ns103
prod-chatman-ancillary-us-east-1
energy
beethoven
root
shortcoming
...
u2
household
prod-chatman-ancillary-us-west-2
steadily
backup02
rts
www.chef
